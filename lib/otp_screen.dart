...
import 'package:fixoo/main.dart';
              ...
              Pinput(
                ...
                focusedPinTheme: defaultPinTheme.copyWith(
                  decoration: defaultPinTheme.decoration!.copyWith(
                    ...
                    boxShadow: [
                      BoxShadow(color: focusedBorderColor.withOpacity(0.2), blurRadius: 15),
                    ],
                  ),
                ),
                submittedPinTheme: defaultPinTheme.copyWith(
                  decoration: defaultPinTheme.decoration!.copyWith(
                    color: fillColor,
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(color: focusedBorderColor.withOpacity(0.5)),
                  ),
                ),
